...
% Process the UPSY unit tests results into a nice, semi-interactive html report.
...
if isempty( input_args)
  ...
  foldername_automated_testing = '/Users/Beren017/Documents/GitHub/UPSY/automated_testing';
...
%%
  ...
  function R = read_unit_tests_structure( filename)
    % Read the UPSY unit tests output file and collect
  ...
  function create_unit_tests_report_html( R, filename)
    ...
    % user can easily inspect the UPSY unit test results.
